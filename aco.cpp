                          ...
                          double dt, double simTime)
{
    ...
    return result.mse; // cost = MSE (lower is better)
}
            ...
            const char* logFilePath)
{
    ...
    for (int iter = 0; iter < settings.maxIterations; iter++) {
        ...
        // Construct + evaluate ants (serial)
